...
def plot_actions(df, title, action_type, selected_game):
    st.title(title)
...
plot_actions(df, 'Cruzamentos na grande área', 'Cruzamento', selected_game)
...
plot_actions(df_shots, f'{selected_action}s a partir de cruzamentos', selected_action, selected_game)

# Gráfico 3: Interceptações de cruzamentos
plot_actions(df, 'Interceptações dos cruzamentos', 'Interceptação', selected_game)
